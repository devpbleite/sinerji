        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">Nome:&nbsp;<?php echo $customer->name; ?></li>
                    <li class="list-group-item">Cpf:&nbsp;<?php echo $customer->cpf; ?></li>
                    <li class="list-group-item">Telefone:&nbsp;<?php echo $customer->phone; ?></li>
                    <li class="list-group-item">E-mail:&nbsp;<?php echo $customer->email; ?></li>
                    <li class="list-group-item">Número de veículos:&nbsp;<?php echo count($customer->cars ?? []); ?></li>
                </ul>
                <hr>
