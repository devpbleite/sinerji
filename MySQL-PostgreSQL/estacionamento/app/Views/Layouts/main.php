...
<head>
  ...
  <title>Estacionamento | <?php echo $this->renderSection('title'); ?></title>
  <!-- plugins:css -->
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/toastify/toastify.css') ?>" />
  <!-- endinject -->
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <!-- Será a área de informações gerais do negócio -->
          ...
          <li class="nav-item">
            <!-- Área de gerência de categorias de vagas -->
            <a class="nav-link" href="<?php echo route_to('categories'); ?>">
              <i class="mdi mdi-grid-large menu-icon"></i>
          ...
          <li class="nav-item">
            <!-- Área de gerência dos mensalistas e carros. -->
            <a class="nav-link" href="<?php echo route_to('customers'); ?>">
              <i class="mdi mdi-grid-large menu-icon"></i>
              <span class="menu-title">Mensalistas</span>
            </a>
          </li>

          <li class="nav-item">
            <!-- Área de gerência das informações da empresa. -->
            <a class="nav-link" href="<?php echo route_to('company'); ?>">
              <i class="mdi mdi-grid-large menu-icon"></i>
              <span class="menu-title">Dados da empresa</span>
            </a>
          </li>
          <!-- Omitindo o restante dos itens na barra de navegação.
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <!-- Esta secão de conteúdo irá renderizar o conteúdo de acordo com o enviado por uma view. -->
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block"><?php echo $company->name ?? ''; ?></span>
