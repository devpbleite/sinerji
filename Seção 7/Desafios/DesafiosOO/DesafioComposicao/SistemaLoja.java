...
public class SistemaLoja {
  ...
  public static void main(String[] args) {
    ...
    compra1.addItem("Iphone", 5000.00, 1);
    compra1.addItem("Macbook Air M1", 10000.00, 1);
    cliente.adicionarCompra(compra1);

    Compra compra2 = new Compra();
    compra2.addItem("Mouse", 350.00, 1);
    compra2.addItem("Teclado", 400.00, 1);
    compra2.addItem("Monitor", 900.00, 1);
